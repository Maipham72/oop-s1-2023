...
int main() {
  ...
  std::cout << "Distance between position 1 and 2: " << distance1 << std::endl;

  std::cout << "Distance between position 1 and 3: " << distance2 << std::endl;

  std::cout << "Distance between position 2 and 3: " << distance3 << std::endl;
